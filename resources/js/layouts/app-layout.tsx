    ...
    return (
        <AppLayoutTemplate breadcrumbs={breadcrumbs} {...props}>
            ...
            {pageProps.flash?.success && (
                <div className="glass-elevated mx-4 mt-4 rounded-xl border-emerald-500/20 bg-emerald-500/15 px-4 py-3 text-sm font-medium text-emerald-700 shadow dark:text-emerald-200">
                    {pageProps.flash.success}
                </div>
            )}

            {pageProps.flash?.error && (
                <div className="glass-elevated mx-4 mt-4 rounded-xl border-red-500/20 bg-red-500/15 px-4 py-3 text-sm font-medium text-red-700 shadow dark:text-red-200">
                    {pageProps.flash.error}
                </div>
            )}
